...
<div class="tab-pane fade container" id="nav-doador" role="tabpanel" aria-labelledby="nav-doador">
    <form action="<?=site_url('administracao/novo_doador')?>" method="POST">
        <div class="form-group">
              ...
              <input name="cpf_usuario" type="text" class="form-control" oninput="cpf_replace(this.form.cpf.value)" placeholder="xxx.xxx.xxx-xx" name="cpf" id="cpf" pattern="\d{3}.\d{3}.\d{3}-\d{2}" title="CPF possui 11 números (Digite apenas os números)" maxlength="15" required>
        </div>
        <button type="submit" class="btn btn-success">Confirmar</button>
    </form>
</div>
